			...
			<div class="row">
				<div class="col-md-12">
					<div class="owl-carousel owl-carousel-fullwidth">
						<div class="item">
							<a href="#">
								<img src="<?php echo get_template_directory_uri();?>/assets/images/carrusel/carrusel_1.jpg" alt="Free Website Template by GetTemplates.co">
						...
						<div class="item">
							<a href="#">
								<img src="<?php echo get_template_directory_uri();?>/assets/images/carrusel/carrusel_2.jpg" alt="Free Website Template by GetTemplates.co">
								<div class="slider-copy">
									<h2>Architecture #1</h2>
								</div>
							</a>
						...
						<div class="item">
							<a href="#">
								<img src="<?php echo get_template_directory_uri();?>/assets/images/carrusel/carrusel_3.jpg" alt="Free Website Template by GetTemplates.co">
								<div class="slider-copy">
									<h2>Architecture #1</h2>
								</div>
							</a>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="owl-carousel owl-carousel-carousel">
							<div class="item">
								<div class="gtco-item">
									<a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/img_1.jpg" alt="" class="img-responsive"></a>
							...
							<div class="item">
								<div class="gtco-item">
									<a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/img_2.jpg" alt="" class="img-responsive"></a>
							...
							<div class="item">
								<div class="gtco-item">
									<a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/img_3.jpg" alt="" class="img-responsive"></a>
